...
//   invalido, se asigna 10 minutos por defecto" y asigna
...
// Descanso invalido, se asigna 10 minutos por defecto
...
public:
    SesionEstudio(int minutosDescanso) {
        if (minutosDescanso <= 0 || minutosDescanso > 60) {
            std::cout << "Descanso invalido, se asigna 10 minutos por defecto\n";
    ...
    ~SesionEstudio() {
        std::cout << "Sesion de estudio finalizada\n";
    }
};
...
int main() {
    {
        // 1. Crear s1...
        SesionEstudio s1(20);
        bool r1 = s1.setHorario(8.0, 10.0);
        std::cout << std::boolalpha;
        std::cout << "Horario 1 aceptado: " << r1 << "\n";

        // 2. Crear s2...
        SesionEstudio s2(90);
        bool r2 = s2.setHorario(23.0, 22.0);
        std::cout << "Horario 2 aceptado: " << r2 << "\n";

        // 3. Crear s3...
        SesionEstudio s3(15);
        bool r3 = s3.setHorario(14.0, 16.0);
        std::cout << "Horario 3 aceptado: " << r3 << "\n";
